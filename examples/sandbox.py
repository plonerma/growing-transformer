...
from growing_transformer.model import Growing
...
class SimpleModel(Growing):
    def __init__(self, n_in, n_out, h, a, b, config={}):
        ...
        self.a = MLP(in_features=n_in, out_features=h, hidden_features=a, config=config)
        self.b = MLP(in_features=h, out_features=n_out, hidden_features=b, config=config)
